...
class Router{
    ...
    // http method and route listener, listen all routes atteched to actual instance
    function __call($name, $args){
        list($route, $method) = $args;
        $name = strtoupper($name);

        // verify is request method if allowed before run route callback
    ...
    // raise request error for invalid resquest method
    ...
    // invoke callback function for specific route
    function resolve(){
